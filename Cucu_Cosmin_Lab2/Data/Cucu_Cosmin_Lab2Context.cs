...
namespace Cucu_Cosmin_Lab2.Data
{
    public class Cucu_Cosmin_Lab2Context : DbContext
    {
        ...
        public DbSet<Cucu_Cosmin_Lab2.Models.Category> Category { get; set; }

        public DbSet<Cucu_Cosmin_Lab2.Models.Member> Member { get; set; }

        public DbSet<Cucu_Cosmin_Lab2.Models.Borrowing> Borrowing { get; set; }
    }
}
